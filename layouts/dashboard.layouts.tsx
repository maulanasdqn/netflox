...
export const DashboardLayout: FC<DashboardLayoutDto> = (
  ...
  return (
    <>
      <Navbar />
      <Banner />
      <section className="flex md:flex-row flex-col gap-y-4 justify-start flex-1 gap-x-4 bg-gray-800 w-full h-[300px] px-6 text-white">
        <section className="bg-gray-200 text-gray-700 w-full rounded-lg h-full flex md:text-4xl items-center justify-center">
          Popular
        </section>
        <section className="bg-gray-700 w-full rounded-lg h-full flex md:text-4xl items-center justify-center">
          Latest
        </section>
        <section className="bg-gray-700 w-full rounded-lg h-full flex md:text-4xl items-center justify-center">
          Rating
